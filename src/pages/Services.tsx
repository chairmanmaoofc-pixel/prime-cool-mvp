      ...
      <section className="py-20 hero-gradient relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center text-primary-foreground">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 animate-fade-up text-justify text-gradient ">
              Our Services
            </h1>
            <p
              style={{
              ...
              className="animate-fade-up text-justify font-medium text-xl text-gradient font-sans"
            >
              Professional AC installation, repair, and maintenance services.
              Fast, reliable, and affordable solutions for all your cooling
              needs.
            </p>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {process.map((item, index) => (
              <div key={index} className="text-center relative">
                ...
                {index < 3 && (
                  <ArrowRight className="hidden md:block absolute top-8 -right-4 w-8 h-8 text-primary" />
                )}
              </div>
            ))}
          </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-2xl mx-auto text-center text-primary-foreground">
            ...
            <p className="text-lg mb-8 text-gradient">
              Book your service today and experience the Optimus Prime
              difference. Fast, professional, and guaranteed satisfaction.
            </p>
